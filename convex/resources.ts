...
export const addResource = mutation({
  args: {
    ...
    type: v.union(v.literal("article"), v.literal("video"), v.literal("audio"), v.literal("exercise")),
...
export const getResources = query({
  args: {
    type: v.optional(v.union(v.literal("article"), v.literal("video"), v.literal("audio"), v.literal("exercise"))),
...
export const searchResources = query({
  ...
  handler: async (ctx, args) => {
    ...
    return resources.filter(resource => {
      ...
      const tagMatch = resource.tags.some(tag => tag.toLowerCase().includes(searchTerm));
